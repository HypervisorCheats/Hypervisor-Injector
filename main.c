...
Routine Description:
    ...
    This is the unload routine for the Hypervisor Injector kernel driver.
...
Routine Description:
    ...
    This is the entry routine for the Hypervisor Injector kernel driver.
...
--*/
{
    ...
    UNICODE_STRING DeviceName = RTL_CONSTANT_STRING(L"\\Device\\hypervisor_PLZNOCRACK");
    ...
    if (NT_SUCCESS(IoGetDeviceObjectPointer(&DeviceName, FILE_READ_DATA, &FileObject, &DeviceObject)))
    {
        ...
        {
            //
            // Executing hypervisor kernel.
            //
            ((void(*)())(RtlFindExportedRoutineByName(VgkDriverObject->DriverStart, "Cumsponge")))();
